...
type CloneInitParameters struct {
	...
	// Clone the virtual machine from a snapshot or a vsphere. Default: false.
...
type MachineInitParameters struct {
	...
	// When specified, the virtual machine will be created as a clone of a specified vsphere. Optional customization options can be submitted for the resource. See creating a virtual machine from a vsphere for more information.
	...
	// The datacenter ID. Required only when deploying an OVF/OVA vsphere.
	...
	NetworkInterface []MachineNetworkInterfaceInitParameters `json:"networkInterface,omitempty" tf:"network_interface,omitempty"`
	...
	// When specified, the virtual machine will be deployed from the provided OVF/OVA vsphere. See creating a virtual machine from an OVF/OVA vsphere for more information.
	...
	// is set to an exact match of the vsphere's controller set. For maximum compatibility, make sure the SCSI controllers on the source vsphere are all the same type.
...
type MachineNetworkInterfaceInitParameters struct {
...
type MachineObservation struct {
	...
	// Computed value which is only valid for cloned virtual machines. A list of vApp transport methods supported by the source virtual machine or vsphere.
...
// Machine is the Schema for the Machines API. Provides a resource for VMware vSphere virtual machines. This resource can be used to create, modify, and delete virtual machines.
