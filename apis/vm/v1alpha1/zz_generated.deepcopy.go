...
func (in *MachineInitParameters) DeepCopyInto(out *MachineInitParameters) {
	*out = *in
	...
	if in.NetworkInterface != nil {
		in, out := &in.NetworkInterface, &out.NetworkInterface
		*out = make([]MachineNetworkInterfaceInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MachineNetworkInterfaceInitParameters) DeepCopyInto(out *MachineNetworkInterfaceInitParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MachineNetworkInterfaceInitParameters.
func (in *MachineNetworkInterfaceInitParameters) DeepCopy() *MachineNetworkInterfaceInitParameters {
	if in == nil {
		return nil
	}
	out := new(MachineNetworkInterfaceInitParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MachineObservation) DeepCopyInto(out *MachineObservation) {
	*out = *in
	...
	if in.NetworkInterface != nil {
		in, out := &in.NetworkInterface, &out.NetworkInterface
		*out = make([]MachineNetworkInterfaceObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
